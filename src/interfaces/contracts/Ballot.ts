...
export interface BallotInterface extends utils.Interface {
  functions: {
    ...
    "walletHoldsToken()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "walletHoldsToken",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Ballot extends BaseContract {
  ...
  functions: {
    ...
    walletHoldsToken(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    walletHoldsToken(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    walletHoldsToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
